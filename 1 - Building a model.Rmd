...
```{r}
DataExplorer::plot_intro(urchins)
```
...
```
 ...
 We’ll save this model object as `lm_mod`:
...
new_points <- expand.grid(initial_volume = 20, # expand.grid creates a DF from all combinations of the supplied vectors 
